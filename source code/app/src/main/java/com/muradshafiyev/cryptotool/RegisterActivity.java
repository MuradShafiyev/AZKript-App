...
import java.util.Map;
 ...
 public class RegisterActivity extends AppCompatActivity {
    ...
    EditText eFullname, eEmail, ePassword1, ePassword2;
    Button btnRegister;
    TextView tLoginBtn, tAlertError;
    FirebaseAuth FBAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eFullname = findViewById(R.id.edtRName);
        eEmail = findViewById(R.id.edtREmail);
        ePassword1 = findViewById(R.id.edtRPassword1);
        ePassword2 = findViewById(R.id.edtRPassword2);
        btnRegister = findViewById(R.id.btnR);
        tLoginBtn = findViewById(R.id.loginTxt);
        checkBox = findViewById(R.id.chckTermsNConditions);
        tAlertError = findViewById(R.id.txtViewError);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(password1)){
                    ePassword1.setError("Password required!");
                    return;
                }

                if(!password1.equals(password2)){
                    ePassword2.setError("Passwords must match!");
                    return;
                }

                if(password1.length() < 6){
                    ePassword1.setError("Password must be at least 6 characters long");
                    return;
                }

                if(!checkBox.isChecked()){
                    tAlertError.setVisibility(View.VISIBLE);
                    tAlertError.setText("You must agree to Terms and Conditions!");
                    return;
                } else {
                    tAlertError.setVisibility(View.INVISIBLE);
                }
...
//                                    });
    ...
    public void alertTERMSANDCONDITIONS(View view){
        ...
        alertDialogBuilder.setMessage(longmsg);
    ...
    String longmsg = "\n" +
            "AZKRIPT APP TERMS & CONDITIONS TEMPLATE\n" +
            "\n" +
            ...
            "\n" +
            "AGREEMENT TO TERMS\n" +
            "These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and AZKript App (“we,” “us” or “our”), concerning your access to and use of the [website name.com] website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agree to be bound by all of these Terms and Conditions Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS and CONDITIONS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.  \n" +
            "\n" +
